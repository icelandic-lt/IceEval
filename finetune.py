...
def finetune_pos(model_path, train_path, test_path, output_path, task, batch_size=16, learning_rate=5e-5, epochs=10):
...
def finetune_dp(model_path, train_path, val_path, test_path, output_path, epochs=200, cwd=None):
...
def finetune_ats(model_path, model_type, data_path, output_path, batch_size, epochs, classifier, pooling_mode):
...
def main():
    ...
    if 'pos' in tasks:
        ...
        for fold in folds:
            ...
            finetune_pos(model_path, train_path, test_path, output_path, **args)
    ...
    if 'ner' in tasks:
        ...
        for fold in folds:
            ...
            finetune_pos(model_path, train_path, test_path, output_path, **task_args['ner'])
    ...
    if 'dp' in tasks:
        ...
        for num_run in runs:
            ...
            finetune_dp(model_path, train_path, val_path, test_path, output_path, epochs, cwd=lib_dir)
    ...
    if 'ats' in tasks:
        ...
        for num_run in runs:
            ...
            finetune_ats(model_path, model_type, ats_dataset_dir, output_path, **task_args['ats'])
